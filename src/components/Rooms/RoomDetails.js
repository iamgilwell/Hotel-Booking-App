                    ...
                    <div className="room-booking">
                        ...
                        <form action="#">
                            ...
                            <div className="select-option">
                                ...
                                </select><div className="nice-select" tabIndex="0"><span className="current">3 Adults</span><ul className="list"><li data-value="" className="option selected">3 Adults</li></ul></div>
                            </div>
                            <div className="select-option">
                                <label htmlFor="room">Room:</label>
                                <select id="room" style={{display: "none"}}>
                                    <option value="">1 Room</option>
                                </select><div className="nice-select" tabIndex="0"><span className="current">1 Room</span><ul className="list"><li data-value="" className="option selected">1 Room</li></ul></div>
                            </div>
